                ...
                <div class="col-md-4 col-md-offset-4" style="width: 1082px; margin-left: 43px;">
                    ...
                    <div class="login-panel panel panel-default"> 
                        ...
                        <div id="navMenu" style="margin-top: 2px;">
                            ...
                            <ul>
                                <li><a href="#"><button class="btn btn-info" style="width: 148px; height: 38px; padding-top: 0px; margin-top: -5px; background-color: #428BCA;"><span class="glyphicon glyphicon-move"></span>My Details</button></a>     
                                </li>
                            </ul>
                            <ul>
                                ...
                                <table class="table table-bordered" style="width: 800px;height: 5px; margin-left: 80px;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>1989-09-11</td>
                                            <td>Kenya</td>
                                            <td style="width: 20px;"><a href="#personalDetails" data-toggle="modal" style="background-color:#E6E2EB; padding:10px 12px; margin-left: -8px; outline: none;"><span class="glyphicon glyphicon-edit">Edit</span></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-bordered" style="width: 800px;height: 5px; margin-left: 80px;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>A-</td>
                                            <td>78</td>
                                            <td style="width: 20px;"><a href="#academicQualifications" data-toggle="modal" style="background-color:#E6E2EB; padding:10px 12px; margin-left: -8px; outline: none;"><span class="glyphicon glyphicon-edit">Edit</span></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-bordered" style="width: 800px;height: 5px; margin-left: 80px;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Full Time</td>
                                            <td>Main Campus</td>
                                            <td style="width: 20px;"><a href="#courseDetails" data-toggle="modal" style="background-color:#E6E2EB; padding:10px 12px; margin-left: -8px; outline: none;"><span class="glyphicon glyphicon-edit">Edit</span></a></td>
                                        </tr>
                                    </tbody>
                                </table>
