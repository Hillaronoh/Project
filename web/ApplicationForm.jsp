                ...
                <div class="col-md-4 col-md-offset-4" style="width: 1082px; margin-left: 43px;">
                    ...
                    <div class="login-panel panel panel-default"> 
                        ...
                        <div id="navMenu" style="margin-top: 5px;">
                            ...
                            <ul>
                                <li><a href="#"><button class="btn btn-info" style="width: 148px; height: 38px; padding-top: 0px; margin-top: -5px; background-color: #428BCA;"><span class="glyphicon glyphicon-arrow-down"></span>Apply Course</button></a>
                                    <ul>
